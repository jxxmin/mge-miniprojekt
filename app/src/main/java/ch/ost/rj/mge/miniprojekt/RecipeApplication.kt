...
class RecipeApplication : Application() {
    override fun onCreate() {
        ...
        //RecipeRepository.addRecipe(Recipe(1, "Schoggikuchen", "Nehme Schokolade und viel Mehl, dann mischen und noch ein rohes Ei. Danach beii 400 Grad backen!"))
        //RecipeRepository.addRecipe(Recipe(2, "Chässpätzli", "Spätzle Packung öffnen und in Pfanne mit Käse vermischen."))
    }
}
